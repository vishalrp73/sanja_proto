    ...
    return (
        <div className = 'ft-comp-wrap'>
                ...
                <div className = 'ft-bottom-bar'>
                        <p className = 'ft-copy-text'>&copy; 2021 Turners</p>

                        <div className = 'ft-bot-text-wrap'>
                            <p className = 'ft-bot-text'>Terms &amp; Conditions</p>
                            <p className = 'ft-bot-text'>Privacy Policy</p>
                            <p className = 'ft-bot-text'>The Shielded Site</p>
                        </div>
                </div>
        </div>
